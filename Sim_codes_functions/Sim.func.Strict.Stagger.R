...
Strict_Stagger_design <- function(dose, startdose, max_n, cohortsize, 
                                  ...
                                  alpha3_bar, tau_alpha3, sce=1, subset=1, File_name="Strict_Stagger"){
...
#  
#  
#  Strict_Stagger_results <- Strict_Stagger_design(dose, startdose, max_n, cohortsize,
#                                              DLT_window, efficacy_window,  stagger_window,
#                                              pi_T_bar, pi_E_bar, eta_elicited_rate, utility.table,
#                                              accrual.rate, arrive.dist,event.dist,
#                                              lambda_d, rho, pT.true, pE.true,
