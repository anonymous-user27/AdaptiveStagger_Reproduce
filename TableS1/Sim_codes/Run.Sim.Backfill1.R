...
#             
#  This file R code to replicate Simulation results for "Backfill" design in Table S1
###################################################################################################################
...
source("Sim_codes_functions/Sim.func.backfill.R")
...
Backfill_design_sce <- Backfill_design(dose, startdose, max_n, cohortsize,
                                       ...
                                       alpha3_bar, tau_alpha3, max_acc, sce, subset,File_name)
#Backfill_design_sce
s2 <- Sys.time()
s2-s1
