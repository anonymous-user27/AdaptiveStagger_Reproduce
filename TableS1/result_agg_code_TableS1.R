...
#             
#  This file R code to aggregate simulation results and get numbers presented in  Table S1(Backfill Design)
###################################################################################################################
...
write.csv(Combined_results,"TableS1/Sim_results_Backfill_TableS1.csv", row.names = FALSE)
