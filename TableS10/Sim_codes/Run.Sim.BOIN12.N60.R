...
#             
#  This file R code to replicate Simulation results for "BOIN12" design in Table S10
###################################################################################################################
...
Final_result1$Method = "BOIN12_N60"
...
filename <-sprintf("Results/BOIN12_N60_ctox_%.2f_ceff_%.2f.csv", cut.tox,cut.eff)
