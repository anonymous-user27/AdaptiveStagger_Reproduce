...
#             
#  This file R code to aggregate simulation results and get numbers presented in Table S10 (Maximum Sample size = 60)
###################################################################################################################
...
library(dplyr)
method_order <- c( "CUB_N60", "Strict_Stagger_N60", "BOIN12_N60","Adaptive_Stagger_N60")
Combined_results <- Combined_results %>%
  mutate(Method = factor(Method, levels = method_order)) %>%
  arrange(Scenario, Method)

write.csv(Combined_results,"TableS10/Sim_results_N60_TableS10.csv", row.names = FALSE)
