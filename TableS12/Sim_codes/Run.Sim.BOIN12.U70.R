...
#             
#  This file R code to replicate Simulation results for "BOIN12" design in Table S12
###################################################################################################################

source("/Sim.func.BOIN12.R")
##scenarios
source("/Sim.scenarios.R")
...
Final_result1$Method = "BOIN12_U70"
...
filename <-sprintf("Results/BOIN12_U70_ctox_%.2f_ceff_%.2f.csv", cut.tox,cut.eff)
