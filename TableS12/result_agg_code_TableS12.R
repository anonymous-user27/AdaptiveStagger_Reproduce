...
#             
#  This file R code to aggregate simulation results and get numbers presented in Table S12 (Alternative Utility)
###################################################################################################################
...
library(dplyr)
method_order <- c( "CUB_U70", "Strict_Stagger_U70", "BOIN12_U70","Adaptive_Stagger_U70")
Combined_results <- Combined_results %>%
  mutate(Method = factor(Method, levels = method_order)) %>%
  arrange(Scenario, Method)

write.csv(Combined_results,"TableS12/Sim_results_U70_TableS12.csv", row.names = FALSE)
