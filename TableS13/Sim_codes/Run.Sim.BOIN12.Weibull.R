...
#             
#  This file R code to replicate Simulation results for "BOIN12" design in Table S13
###################################################################################################################
...
Final_result1$Method = "BOIN12_Weibull"
...
filename <-sprintf("Results/BOIN12_Weibull_ctox_%.2f_ceff_%.2f.csv", cut.tox,cut.eff)
