...
#             
#  This file R code to replicate Simulation results for "Adaptive Stagger" design in Table S4
###################################################################################################################
...
##scenarios
source("Sim_codes_functions/TableS4/Sim.scenarios.TableS4.R")
...
File_name="Adaptive_Stagger_nonpredict"
