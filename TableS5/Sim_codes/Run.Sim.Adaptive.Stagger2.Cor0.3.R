...
#             
#  This file R code to replicate Simulation results for "Adaptive Stagger" design in Table S5
###################################################################################################################
...
File_name="Adaptive_Stagger_Cor0.3"
...
Adaptive_Stagger_sce <- Adaptive_Stagger_design(dose, startdose, max_n, cohortsize,
                                            ...
                                            alpha3_bar, tau_alpha3,  sce, subset,File_name,rho.time = 0.3)
