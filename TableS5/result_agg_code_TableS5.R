...
#             
#  This file R code to aggregate simulation results and get numbers presented in  Table S5 
#  (non zero correlation between time to DLT and time to response)
###################################################################################################################
...
############# Adaptive Stagger, Cor=0.3  ###############

Design = "Adaptive_Stagger_Cor0.3"
ndose = 5
Nsim=25
cut.tox <- c(0.1)
cut.eff <- c(0.05)
...
############# Adaptive Stagger, Cor=0.5  ###############

Design = "Adaptive_Stagger_Cor0.5"
ndose = 5
Nsim=25
cut.tox <- c(0.1)
cut.eff <- c(0.05)
...
############# Adaptive Stagger, Cor=0.8  ###############

Design = "Adaptive_Stagger_Cor0.8"
ndose = 5
Nsim=25
cut.tox <- c(0.1)
cut.eff <- c(0.05)
...
write.csv(Combined_results,"TableS5/Sim_results_Cor_TableS5.csv", row.names = FALSE)
