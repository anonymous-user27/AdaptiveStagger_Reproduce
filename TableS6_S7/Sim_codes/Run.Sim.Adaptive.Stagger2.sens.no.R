...
#             
#  This file R code to replicate Simulation results of Sensitivity analysis for Adaptive Stagger design with the
#  rule U(non-stagger) ≥ U(stagger) in Tables S6 and S7
###################################################################################################################
...
source("Sim_codes_functions/TableS6_S7/Sim.func.Adaptive.Stagger.sens.Tab6_7.R")
##scenarios
...
File_name="Adaptive_Stagger_sens_no"
