...
#             
#  This file R code to aggregate simulation results and get numbers presented in  Tables S6 and S7 
#  ( Sensitivity analysis for Adaptive Stagger design with the rule U(non-stagger) ≥ U(stagger))
###################################################################################################################
...
############# Adaptive Stagger, no efficacy decay  ###############

Design = "Adaptive_Stagger_sens_no"
ndose = 5
Nsim=25
cut.tox <- c(0.1)
cut.eff <- c(0.05)
...
############# Adaptive Stagger, moderate efficacy decay  ###############

Design = "Adaptive_Stagger_sens_A"
ndose = 5
Nsim=25
cut.tox <- c(0.1)
cut.eff <- c(0.05)
...
############# Adaptive Stagger, quick efficacy decay  ###############

Design = "Adaptive_Stagger_sens_B"
ndose = 5
Nsim=25
cut.tox <- c(0.1)
cut.eff <- c(0.05)
...
write.csv(Combined_results,"TableS6_S7/Sim_results_sens_TableS6_S7.csv", row.names = FALSE)
