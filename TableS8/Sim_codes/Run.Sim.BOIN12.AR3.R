...
#             
#  This file R code to replicate Simulation results for "BOIN12" design in Table S8
###################################################################################################################
...
Final_result1$Method = "BOIN12_AR3"
...
filename <-sprintf("Results/BOIN12_AR3_ctox_%.2f_ceff_%.2f.csv", cut.tox,cut.eff)
