...
#             
#  This file R code to aggregate simulation results and get numbers presented in Table S8 (Accrual Rate 3 pts/month)
###################################################################################################################
...
library(dplyr)
method_order <- c( "CUB_AR3", "Strict_Stagger_AR3", "BOIN12_AR3","Adaptive_Stagger_AR3")
Combined_results <- Combined_results %>%
  mutate(Method = factor(Method, levels = method_order)) %>%
  arrange(Scenario, Method)

write.csv(Combined_results,"TableS8/Sim_results_AR3_TableS8.csv", row.names = FALSE)
