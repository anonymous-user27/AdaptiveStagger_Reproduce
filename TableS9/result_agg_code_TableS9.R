...
#             
#  This file R code to aggregate simulation results and get numbers presented in Table S9 (Accrual Rate 7 pts/month)
###################################################################################################################
...
library(dplyr)
method_order <- c( "CUB_AR7", "Strict_Stagger_AR7", "BOIN12_AR7","Adaptive_Stagger_AR7")
Combined_results <- Combined_results %>%
  mutate(Method = factor(Method, levels = method_order)) %>%
  arrange(Scenario, Method)

write.csv(Combined_results,"TableS9/Sim_results_AR7_TableS9.csv", row.names = FALSE)
