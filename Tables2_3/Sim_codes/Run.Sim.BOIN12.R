...
#             
#  This file R code to replicate Simulation results for "BOIN12" design in Table 2
###################################################################################################################
...
filename <-sprintf("Results/BOIN12_ctox_%.2f_ceff_%.2f.csv", cut.tox,cut.eff)
write.csv(Final_result_combine,file=filename,row.names = FALSE)
